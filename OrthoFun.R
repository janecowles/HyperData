...
RemoteSenDataLoc <- "I:/RemoteSensing/RESCUE/" #2019July30BigBioFab1/100062_bf_2019_07_30_16_05_48
FolderLoc <- "RESCUE-2019-09-15-Hyper/100092_rescS_2019_09_15_19_15_39/"
CoordSystem <- 32615
...
imu.framematch <- imu_framecombine()
...
# fwrite(Proc_IMU,"~/Proc_IMU_19Aug2019_BB.csv")
...
# system.time(sv <- ortho_fun(8000,Proc_IMU,bandtowave,output="dataframe",printtofile=F))
# ggplot(sv2,aes(Lon2,Lat2,color=nm540.751))+geom_point()
# system.time(sv2 <- ortho_fun(6000,Proc_IMU,bandtowave,output="dataframe",printtofile=F))
